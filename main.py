...
api = FastAPI(redoc_url=None, description="The rate limit is 5 requests per second. This is not per page. When we upgrade our server we will allow people to make more requests. Also if you reach over 200 requests in 10 seconds your IP will be banned for 1 minute.")
